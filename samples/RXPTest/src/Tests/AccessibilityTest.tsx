...
class AccessibilityView extends RX.Component<RX.CommonProps, RX.Stateless> {
    render() {
        return (
            <RX.View style={ _styles.container}>
                ...
                <RX.View style={ _styles.labelContainer }>
                    <RX.Text style={ _styles.labelText }>
                        { RX.Accessibility.isScreenReaderEnabled() ? 'Screen Reader On' : 'Screen Reader Off' }
                    </RX.Text>
                </RX.View>
                ...
                <RX.View style={ _styles.labelContainer }>
                    <RX.Text style={ _styles.labelText }>
                        { RX.Accessibility.isHighContrastEnabled() ? 'High Contrast On' : 'High Contrast Off' }
                    </RX.Text>
                </RX.View>
