...
export class Scrollbar {
    ...
    private _handleMouseDown(e: React.MouseEvent) {
        ...
        if (this._dragging === true || !currentTarget) {
            this._prevent(e);
            return;
        }

        if (this._hasVertical) {
            const eventOffsetY = e.pageY - currentTarget.getBoundingClientRect().top;
            ...
            const eventOffsetX = e.pageX - currentTarget.getBoundingClientRect().left;
