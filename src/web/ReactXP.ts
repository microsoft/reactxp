...
import { ImageSvg as ImageSvgImpl } from './Svg/ImageSvg';
...
import { SvgPath as SvgPathImpl } from './Svg/SvgPath';
...
module ReactXP {
    ...
    export type ImageSvg = ImageSvgImpl;
    ...
    export type SvgPath = SvgPathImpl;
